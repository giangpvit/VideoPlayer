...
var onPlayerReady = function onPlayerReady(player, options) {
	...
	updateElementWidth(player, defaults.thumbnailSize);
...
var createElements = function createElements(player, options) {
	...
	playlistsElemen.setAttribute("id", "id_vjs-playlist");
...
var handleFullscreenchange = function handleFullscreenchange() {
	if (player.isFullscreen() === true) {
		hidePlayListFullChange();
		updateElementWidth(player, 0);
	} else {
		displayPlayListFullChange();
		updateElementWidth(player, defaults.thumbnailSize);
	}
};

var hidePlayListFullChange = function hidePlayListFullChange() {
	playlistsElemen = document.getElementById("id_vjs-playlist");
	playlistsElemen.style.display = 'none';
};

var displayPlayListFullChange = function displayPlayListFullChange() {
	playlistsElemen = document.getElementById("id_vjs-playlist");
	playlistsElemen.style.display = 'block';
};
...
*/
var updateElementWidth = function updateElementWidth(player, width) {
	var resize = function resize(p, itemWidth) {
